...
class Changeset < ActiveRecord::Base
  ...
  def fix_issue(issue)
    ...
    journal = issue.init_journal(user || User.anonymous, l(:text_status_changed_by_changeset, :locale => Setting.default_language, :value => text_tag(issue.project), :author => issue.author.firstname))
    issue.status = status
